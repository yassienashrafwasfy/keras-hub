...
@keras_hub_export("keras_hub.models.MobileCLIP2TextEncoder")
class MobileCLIP2TextEncoder(Backbone):
    """MobileCLIP2 text core network with hyperparameters.

    This is the standard CLIP text transformer (used verbatim by MobileCLIP-B),
    with causal attention masking and plain `gelu` activation.
        ...
        **kwargs,
        ...
        self.encoder_layers = [
            MobileCLIP2EncoderLayer(
                ...
                layer_norm_epsilon=1e-5,  # open_clip text tower uses `1e-5`.
                dtype=dtype,
