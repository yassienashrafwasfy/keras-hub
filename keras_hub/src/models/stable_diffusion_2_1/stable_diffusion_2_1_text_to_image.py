...
@keras_hub_export("keras_hub.models.StableDiffusion2_1TextToImage")
class StableDiffusion2_1TextToImage(TextToImage):
    """An end-to-end Stable Diffusion v2.1 model for text-to-image generation.

    This model has a `generate()` method, which generates images based on a
    prompt.

    Args:
        backbone: A `keras_hub.models.StableDiffusion2_1Backbone` instance.
        preprocessor: A
            `keras_hub.models.StableDiffusion2_1TextToImagePreprocessor`
            instance.
    ...
    ```python
    text_to_image = keras_hub.models.StableDiffusion2_1TextToImage.from_preset(
        "stable_diffusion_2_1", image_shape=(768, 768, 3)
    )
    ...
    preprocessor_cls = StableDiffusion2_1TextToImagePreprocessor
